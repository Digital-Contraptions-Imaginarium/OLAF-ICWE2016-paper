...
\subsection{The Open Legal Address File}
    ...
    To make things worse, in October 2013 Royal Mail and its assets were privatised, including PAF\footnote{\url{http://www.theguardian.com/uk-news/2014/mar/17/royal-mail-privatisation-ministers-rebuked-selling-data}}. The UK Parliament House of Commons' Public Administration Select Committee, just a few month later, called this "unacceptable and unnecessary" and recognised that PAF's "disposal for a short-term gain will impede economic innovation and growth" \cite{pascod}.

    The history of PAF thus far creates an ideal case study for what the objective we described in this chapter is. We know of a very specific and real case where data, whose social and economic value is substantial and can't be expected to be made open. Using social machines to create an alternative to PAF is a great and compelling opportunity to study and test these systems' potential. We will call this the "Open Legal Address File" use case, or "OLAF".
