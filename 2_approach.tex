...
\subsection{Crowdsourcing house numbers to enable inference}
    ...
    \subsubsection{Task model}
        ...
        \textbf{Results aggregation and quality.} Quality is defined by a combination of (a) accuracy of the Workers in responding to tests questions, and (b) consensus in the data submitted through the surveys. Aggregation takes place accordingly as explained below.
